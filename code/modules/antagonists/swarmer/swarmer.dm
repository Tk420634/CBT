...
/obj/effect/mob_spawn/swarmer
	...
	mob_type = /mob/living/danimal/hostile/swarmer
	mob_name = "a swarmer"
...
/mob/living/danimal/hostile/swarmer/Initialize()
	. = ..()
	remove_verb(src, /mob/living/verb/pulled)
	for(var/datum/atom_hud/data/diagnostic/diag_hud in GLOB.huds)
		diag_hud.add_to_hud(src)

/mob/living/danimal/hostile/swarmer/med_hud_set_health()
	var/image/holder = hud_list[DIAG_HUD]
	var/icon/I = icon(icon, icon_state, dir)
	holder.pixel_y = I.Height() - world.icon_size
	holder.icon_state = "huddiag[RoundDiagBar(health/maxHealth)]"

/mob/living/danimal/hostile/swarmer/med_hud_set_status()
	var/image/holder = hud_list[DIAG_STAT_HUD]
	var/icon/I = icon(icon, icon_state, dir)
	holder.pixel_y = I.Height() - world.icon_size
	holder.icon_state = "hudstat"

/mob/living/danimal/hostile/swarmer/Stat()
	..()
	if(statpanel("Status"))
		stat("Resources:",resources)

/mob/living/danimal/hostile/swarmer/emp_act()
	. = ..()
	if(. & EMP_PROTECT_SELF)
		return
	if(health > 1)
...
/mob/living/danimal/hostile/swarmer/CanAllowThrough(atom/movable/O)
...
/mob/living/danimal/hostile/swarmer/CtrlClickOn(atom/A)
	face_atom(A)
	if(!isturf(loc))
		return
...
/mob/living/danimal/hostile/swarmer/proc/Fabricate(atom/fabrication_object,fabrication_cost = 0)
	if(!isturf(loc))
...
/mob/living/danimal/hostile/swarmer/proc/Integrate(atom/movable/target)
	if(isobj(target))
		var/obj/O = target
...
/mob/living/danimal/hostile/swarmer/proc/DisIntegrate(atom/movable/target)
	new /obj/effect/temp_visual/swarmer/disintegration(get_turf(target))
	do_attack_animation(target)
	DelayNextAction(CLICK_CD_MELEE)
	target.ex_act(EXPLODE_LIGHT)

/mob/living/danimal/hostile/swarmer/proc/DisperseTarget(mob/living/target)
	if(target == src)
		return
...
/mob/living/danimal/hostile/swarmer/electrocute_act(shock_damage, source, siemens_coeff = 1, flags = NONE)
	if(!(flags & SHOCK_TESLA))
		return FALSE
	return ..()

/mob/living/danimal/hostile/swarmer/proc/DismantleMachine(obj/machinery/target)
	do_attack_animation(target)
...
/obj/structure/swarmer/trap/proc/on_entered(atom/movable/AM)
	...
	if(isliving(AM))
		var/mob/living/L = AM
		if(!istype(L, /mob/living/danimal/hostile/swarmer))
...
/mob/living/danimal/hostile/swarmer/proc/CreateTrap()
...
/mob/living/danimal/hostile/swarmer/proc/CreateBarricade()
...
/mob/living/danimal/hostile/swarmer/proc/CreateSwarmer()
	set name = "Replicate"
	set category = "Swarmer"
...
/mob/living/danimal/hostile/swarmer/proc/SwarmerTypeToCreate()
	return /obj/effect/mob_spawn/swarmer


/mob/living/danimal/hostile/swarmer/proc/RepairSelf()
...
/mob/living/danimal/hostile/swarmer/proc/ToggleLight()
	if(!light_range)
		set_light_on(TRUE)
	else
		set_light_on(FALSE)

/mob/living/danimal/hostile/swarmer/proc/swarmer_chat(msg)
...
/mob/living/danimal/hostile/swarmer/proc/ContactSwarmers()
