...
*/
	...
	if(href_list["editrightsbrowsermanage"])
		...
		switch(href_list["simplemake"])
			...
			if("slime")
				M.change_mob_type( /mob/living/danimal/slime , null, null, delmob )
			if("monkey")
				M.change_mob_type( /mob/living/carbon/monkey , null, null, delmob )
			if("robot")
				M.change_mob_type( /mob/living/silicon/robot , null, null, delmob )
			if("cat")
				M.change_mob_type( /mob/living/danimal/pet/cat , null, null, delmob )
			if("runtime")
				M.change_mob_type( /mob/living/danimal/pet/cat/Runtime , null, null, delmob )
			if("corgi")
				M.change_mob_type( /mob/living/danimal/pet/dog/corgi , null, null, delmob )
			if("ian")
				M.change_mob_type( /mob/living/danimal/pet/dog/corgi/Ian , null, null, delmob )
			if("pug")
				M.change_mob_type( /mob/living/danimal/pet/dog/pug , null, null, delmob )
			if("crab")
				M.change_mob_type( /mob/living/danimal/crab , null, null, delmob )
			if("coffee")
				M.change_mob_type( /mob/living/danimal/crab/Coffee , null, null, delmob )
			if("parrot")
				M.change_mob_type( /mob/living/danimal/parrot , null, null, delmob )
			if("polyparrot")
				M.change_mob_type( /mob/living/danimal/parrot/Poly , null, null, delmob )
			if("constructarmored")
				M.change_mob_type( /mob/living/danimal/hostile/construct/armored , null, null, delmob )
			if("constructbuilder")
				M.change_mob_type( /mob/living/danimal/hostile/construct/builder , null, null, delmob )
			if("constructwraith")
				M.change_mob_type( /mob/living/danimal/hostile/construct/wraith , null, null, delmob )
			if("shade")
				M.change_mob_type( /mob/living/danimal/shade , null, null, delmob )
