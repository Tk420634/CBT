/obj/item/rig/unathi
	...
	armor_list = list(melee = 30, bullet = 30, laser = 30, energy = 30, bomb = 45, bio = 100, rad = 50)
	emp_protection = -20
	active_slowdown = 6
	offline_slowdown = 10
...
/obj/item/rig/unathi/fancy
	...
	armor_list = list(melee = 45, bullet = 45, laser = 45, energy = 45, bomb = 45, bio = 100, rad = 75) //Takes TEN TIMES as much damage to stop someone in a breacher. In exchange, it's slow. //Whoever made this was on meth
