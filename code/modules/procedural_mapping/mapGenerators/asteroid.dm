...
/datum/mapGeneratorModule/splatterLayer/asteroidMonsters
	spawnableTurfs = list()
	spawnableAtoms = list(/mob/living/danimal/hostile/asteroid/basilisk = 10, \
		/mob/living/danimal/hostile/asteroid/hivelord = 10, \
		/mob/living/danimal/hostile/asteroid/goliath = 10)
