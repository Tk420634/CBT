...
/datum/mapGeneratorModule/splatterLayer/lavalandMonsters
	spawnableTurfs = list()
	spawnableAtoms = list(/mob/living/danimal/hostile/asteroid/goliath/beast = 10,
	/mob/living/danimal/hostile/asteroid/hivelord/legion = 10,
	/mob/living/danimal/hostile/asteroid/basilisk/watcher = 10)
