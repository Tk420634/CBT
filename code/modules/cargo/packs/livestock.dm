...
/datum/supply_pack/critter/parrot
	...
	cost = 4000
	contains = list(/mob/living/danimal/parrot)
	crate_name = "parrot crate"

/datum/supply_pack/critter/parrot/generate()
	. = ..()
	for(var/i in 1 to 4)
		new /mob/living/danimal/parrot(.)
	if(prob(1))
		new /mob/living/danimal/parrot/clock_hawk(.)
...
/datum/supply_pack/critter/butterfly
	...
	contraband = TRUE
	cost = 5000
	contains = list(/mob/living/danimal/butterfly)
	crate_name = "entomology samples crate"

/datum/supply_pack/critter/butterfly/generate()
	. = ..()
	for(var/i in 1 to 49)
		new /mob/living/danimal/butterfly(.)
...
/datum/supply_pack/critter/cat
	...
	contains = list(/mob/living/danimal/pet/cat,
...
/datum/supply_pack/critter/cat/generate()
	. = ..()
	if(prob(50))
		var/mob/living/danimal/pet/cat/C = locate() in .
		qdel(C)
		new /mob/living/danimal/pet/cat/Proc(.)

/datum/supply_pack/critter/chick
	name = "Chicken Crate"
	desc = "The chicken goes bwaak!"
	cost = 2000
	contains = list(/mob/living/danimal/chick)
...
/datum/supply_pack/critter/crab
	...
	cost = 5000
	contains = list(/mob/living/danimal/crab)
...
/datum/supply_pack/critter/corgi
	...
	cost = 5000
	contains = list(/mob/living/danimal/pet/dog/corgi,
					/obj/item/clothing/neck/petcollar)
...
/datum/supply_pack/critter/corgi/generate()
	. = ..()
	if(prob(50))
		var/mob/living/danimal/pet/dog/corgi/D = locate() in .
		if(D.gender == FEMALE)
			qdel(D)
			new /mob/living/danimal/pet/dog/corgi/Lisa(.)
...
/datum/supply_pack/critter/corgis/exotic
	...
	cost = 5500
	contains = list(/mob/living/danimal/pet/dog/corgi/exoticcorgi,
					/obj/item/clothing/neck/petcollar)
...
/datum/supply_pack/critter/cow
	...
	cost = 3000
	contains = list(/mob/living/danimal/cow)
...
/datum/supply_pack/critter/fox
	...
	cost = 5000
	contains = list(/mob/living/danimal/pet/fox,
					/obj/item/clothing/neck/petcollar)
...
/datum/supply_pack/critter/goat
	...
	cost = 2500
	contains = list(/mob/living/danimal/hostile/retaliate/goat)
...
/datum/supply_pack/critter/goose
	...
	cost = 2500
	contains = list(/mob/living/danimal/hostile/retaliate/goose)
...
/datum/supply_pack/critter/pug
	...
	cost = 5000
	contains = list(/mob/living/danimal/pet/dog/pug,
					/obj/item/clothing/neck/petcollar)
...
/datum/supply_pack/critter/snake
	...
	cost = 3000
	contains = list(/mob/living/danimal/hostile/retaliate/poison/snake,
...
/datum/supply_pack/critter/secbat
	...
	cost = 2500
	contains = list(/mob/living/danimal/hostile/retaliate/bat/secbat,
					/mob/living/danimal/hostile/retaliate/bat/secbat,
					/mob/living/danimal/hostile/retaliate/bat/secbat,
					/mob/living/danimal/hostile/retaliate/bat/secbat,
					/mob/living/danimal/hostile/retaliate/bat/secbat)
