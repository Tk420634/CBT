...
/obj/item/clothing/suit/armor/medium/vestarmor
	...
	armor_list = list("melee" = 15, "bullet" = 45, "laser" = 10, "energy" = 10, "bomb" = 30, "bio" = 0, "rad" = 0, "fire" = 5, "acid" = -5)
...
/obj/item/clothing/suit/armor/medium/vestchinese
	...
	armor_list = list("melee" = 20, "bullet" = 35, "laser" = 5, "energy" = 5, "bomb" = 25, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = -10)
...
/obj/item/clothing/suit/armor/medium/scrapchest
	...
	armor_list = list("melee" = 40, "bullet" = 30, "laser" = 15, "energy" = 15, "bomb" = 30, "bio" = 0, "rad" = 5, "fire" = 10, "acid" = 0)
	slowdown = 0.125
...
/obj/item/clothing/suit/armor/medium/scrapchest/reinforced
	...
	armor_list = list("melee" = 40, "bullet" = 35, "laser" = 20, "energy" = 15, "bomb" = 30, "bio" = 0, "rad" = 5, "fire" = 10, "acid" = 0)
...
/obj/item/clothing/suit/armor/medium/brokencombat
	...
	armor_list = list("melee" = 20, "bullet" = 20, "laser" = 15, "energy" = 10, "bomb" = 20, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 0)
...
/obj/item/clothing/suit/armor/medium/vest/breastplate/reinforced
	...
	armor_list = list("melee" = 25, "bullet" = 25, "laser" = 30, "energy" = 10, "bomb" = 5, "bio" = 0, "rad" = 0, "fire" = 20, "acid" = -10)
	slowdown = 0.11
...
/obj/item/clothing/suit/armor/medium/combat
	...
	armor_list = list("melee" = 35, "bullet" = 35, "laser" = 30, "energy" = 20, "bomb" = 25, "bio" = 10, "rad" = 10, "fire" = 20, "acid" = 10)
...
/obj/item/clothing/suit/armor/medium/combat/duster
	...
	armor_list = list("melee" = 30, "bullet" = 35, "laser" = 30, "energy" = 20, "bomb" = 25, "bio" = 10, "rad" = 15, "fire" = 25, "acid" = 10)
...
/obj/item/clothing/suit/armor/medium/combat/swat
	...
	armor_list = list("melee" = 40, "bullet" = 30, "laser" = 25, "energy" = 15, "bomb" = 30, "bio" = 10, "rad" = 10, "fire" = 25, "acid" = 10)
...
/obj/item/clothing/suit/armor/medium/combat/rusted
	...
	armor_list = list("melee" = 35, "bullet" = 30, "laser" = 25, "energy" = 15, "bomb" = 20, "bio" = 10, "rad" = 10, "fire" = 20, "acid" = 10)
...
/obj/item/clothing/suit/armor/medium/supafly
	...
	armor_list = list("melee" = 25, "bullet" = 40, "laser" = 20, "energy" = 10, "bomb" = 20, "bio" = 0, "rad" = 0, "fire" = 25, "acid" = 25)
...
/obj/item/clothing/suit/armor/medium/rebel
	...
	armor_list = list("melee" = 25, "bullet" = 30, "laser" = 20, "energy" = 20, "bomb" = 40, "bio" = 0, "rad" = 0, "fire" = 25, "acid" = 20)
...
/obj/item/clothing/suit/armor/medium/sadist
	...
	armor_list = list("melee" = 30, "bullet" = 25, "laser" = 25, "energy" = 25, "bomb" = 30, "bio" = 0, "rad" = 0, "fire" = 15, "acid" = 5)
...
/obj/item/clothing/suit/armor/medium/blastmaster
	...
	flash_protect = 2
	armor_list = list("melee" = 25, "bullet" = 25, "laser" = 20, "energy" = 25, "bomb" = 60, "bio" = 0, "rad" = 0, "fire" = 50, "acid" = 25)
...
/obj/item/clothing/suit/armor/medium/yankee
	...
	armor_list = list("melee" = 40, "bullet" = 20, "laser" = 15, "energy" = 15, "bomb" = 30, "bio" = 0, "rad" = 0, "fire" = 25, "acid" = 25)
...
/obj/item/clothing/suit/armor/medium/painspike
	...
	armor_list = list("melee" = 40, "bullet" = 25, "laser" = 10, "energy" = 5, "bomb" = 5, "bio" = 0, "rad" = 0, "fire" = 25, "acid" = 5)
...
/obj/item/clothing/suit/armor/medium/iconoclast
	...
	armor_list = list("melee" = 25, "bullet" = 30, "laser" = 25, "energy" = 30, "bomb" = 30, "bio" = 40, "rad" = 60, "fire" = 25, "acid" = 40)
...
/obj/item/clothing/suit/armor/medium/khancoat
	...
	armor_list = list("melee" = 35, "bullet" = 25, "laser" = 15, "energy" = 20, "bomb" = 20, "bio" = 5, "rad" = 10, "fire" = 20, "acid" = 10)
...
/obj/item/clothing/suit/armor/medium/ncrexile
	...
	armor_list = list("melee" = 30, "bullet" = 35, "laser" = 30, "energy" = 25, "bomb" = 30, "bio" = 20, "rad" = 20, "fire" = 15, "acid" = 0)
...
/obj/item/clothing/suit/armor/medium/legexile
	...
	armor_list = list("melee" = 45, "bullet" = 30, "laser" = 20, "energy" = 15, "bomb" = 30, "bio" = 25, "rad" = 20, "fire" = 35, "acid" = 0)
...
/obj/item/clothing/suit/armor/medium/armoredcoat
	...
	armor_list = list("melee" = 20, "bullet" = 35, "laser" = 30, "energy" = 25, "bomb" = 20, "bio" = 5, "rad" = 10, "fire" = 25, "acid" = 5)
...
/obj/item/clothing/suit/armor/medium/slam
	...
	armor_list = list("melee" = 45, "bullet" = 20, "laser" = 0, "energy" = 0, "bomb" = 40, "bio" = 10, "rad" = 10, "fire" = -25, "acid" = 0)
...
/obj/item/clothing/suit/armor/medium/scrapcombat
	...
	armor_list = list("melee" = 35, "bullet" = 25, "laser" = 15, "energy" = 10, "bomb" = 15, "bio" = 0, "rad" = 0, "fire" = 10, "acid" = 5)
...
/obj/item/clothing/suit/armor/medium/forgemaster
	...
	armor_list = list("melee" = 45, "bullet" = 30, "laser" = 20, "energy" = 20, "bomb" = 30, "bio" = 5, "rad" = 10, "fire" = 45, "acid" = 10)
...
/obj/item/clothing/suit/armor/medium/vet
	...
	armor_list = list("melee" = 45, "bullet" = 30, "laser" = 20, "energy" = 15, "bomb" = 30, "bio" = 5, "rad" = 5, "fire" = 35, "acid" = 0)
	slowdown = 0.075
...
/obj/item/clothing/suit/armor/medium/vexil
	...
	armor_list = list("melee" = 45, "bullet" = 35, "laser" = 25, "energy" = 20, "bomb" = 35, "bio" = 5, "rad" = 5, "fire" = 35, "acid" = 0)
	slowdown = 0.075
...
/obj/item/clothing/suit/armor/medium/ncrarmor
	...
	armor_list = list("melee" = 15, "bullet" = 35, "laser" = 15, "energy" = 10, "bomb" = 10, "bio" = 0, "rad" = 0, "fire" = 5, "acid" = 0)
...
/obj/item/clothing/suit/armor/medium/ncrarmormant
	...
	armor_list = list("melee" = 15, "bullet" = 35, "laser" = 15, "energy" = 10, "bomb" = 10, "bio" = 0, "rad" = 0, "fire" = 10, "acid" = 5)
...
/obj/item/clothing/suit/armor/medium/ncrarmorreinf
	...
	armor_list = list("melee" = 20, "bullet" = 40, "laser" = 15, "energy" = 10, "bomb" = 15, "bio" = 0, "rad" = 0, "fire" = 5, "acid" = 0)
...
/obj/item/clothing/suit/armor/medium/ncrarmormantreinf
	...
	armor_list = list("melee" = 20, "bullet" = 40, "laser" = 15, "energy" = 10, "bomb" = 15, "bio" = 0, "rad" = 0, "fire" = 10, "acid" = 5)
...
/obj/item/clothing/suit/armor/medium/ncrarmorofficer
	...
	armor_list = list("melee" = 25, "bullet" = 45, "laser" = 15, "energy" = 10, "bomb" = 20, "bio" = 0, "rad" = 0, "fire" = 10, "acid" = 5)
...
/obj/item/clothing/suit/armor/medium/combat/desert_ranger
	...
	armor_list = list("melee" = 35, "bullet" = 35, "laser" = 15, "energy" = 20, "bomb" = 25, "bio" = 10, "rad" = 10, "fire" = 15, "acid" = 10)
...
/obj/item/clothing/suit/armor/medium/ncrarmorcolonel
	...
	armor_list = list("melee" = 45, "bullet" = 45, "laser" = 40, "energy" = 40, "bomb" = 45, "bio" = 40, "rad" = 45, "fire" = 45, "acid" = 20)
...
/obj/item/clothing/suit/armor/medium/combat/vetranger
	...
	armor_list = list("melee" = 45, "bullet" = 45, "laser" = 30, "energy" = 25, "bomb" = 25, "bio" = 10, "rad" = 20, "fire" = 35, "acid" = 10)
...
/obj/item/clothing/suit/armor/medium/combat/mk2/knight
	...
	armor_list = list("melee" = 35, "bullet" = 40, "laser" = 40, "energy" = 30, "bomb" = 30, "bio" = 10, "rad" = 20, "fire" = 25, "acid" = 10)
...
/obj/item/clothing/suit/armor/medium/combat/mk2/senknight
	...
	armor_list = list("melee" = 40, "bullet" = 40, "laser" = 40, "energy" = 30, "bomb" = 30, "bio" = 10, "rad" = 25, "fire" = 25, "acid" = 10)
...
/obj/item/clothing/suit/armor/medium/combat/mk2/headknight
	...
	armor_list = list("melee" = 40, "bullet" = 40, "laser" = 40, "energy" = 30, "bomb" = 30, "bio" = 15, "rad" = 25, "fire" = 30, "acid" = 15)
...
/obj/item/clothing/suit/armor/medium/lawcoat
	...
	armor_list = list("melee" = 40, "bullet" = 40, "laser" = 30, "energy" = 25, "bomb" = 30, "bio" = 30, "rad" = 30, "fire" = 40, "acid" = 5)
...
/obj/item/clothing/suit/armor/medium/lawcoat/sheriff
	...
	armor_list = list("melee" = 45, "bullet" = 45, "laser" = 35,  "energy" = 40, "bomb" = 30, "bio" = 40, "rad" = 40, "fire" = 50, "acid" = 10)
...
/obj/item/clothing/suit/armor/medium/lawcoat/commissioner
	...
	armor_list = list("melee" = 40, "bullet" = 60, "laser" = 30,  "energy" = 35, "bomb" = 30, "bio" = 40, "rad" = 40, "fire" = 50, "acid" = 10)
...
/obj/item/clothing/suit/armor/medium/vest/breastplate/town
	...
	armor_list = list("melee" = 30, "bullet" = 35, "laser" = 35, "energy" = 15, "bomb" = 10, "bio" = 0, "rad" = 0, "fire" = 20, "acid" = -10)
	slowdown = 0.11
...
/obj/item/clothing/suit/armor/medium/duster/cloak_armored
	...
	armor_list = list("melee" = 25, "bullet" = 35, "laser" = 20, "energy" = 15, "bomb" = 20, "bio" = 5, "rad" = 10, "fire" = 25, "acid" = 5)
...
/obj/item/clothing/suit/armor/medium/motorball
	...
	armor_list = list("melee" = 40, "bullet" = 25, "laser" = 15, "energy" = 15, "bomb" = 10, "bio" = 0, "rad" = 0, "fire" = 40, "acid" = 10)
