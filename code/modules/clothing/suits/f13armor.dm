...
/obj/item/clothing/suit/armor/light/leather/leather_jacket
	...
	armor_list = list("melee" = 25, "bullet" = 15, "laser" = 15, "energy" = 15, "bomb" = 25, "bio" = 0, "rad" = 0, "fire" = 10, "acid" = 0, "wound" = 25)
...
/obj/item/clothing/suit/armor/light/leather/leather_jacketmk2
	...
	armor_list = list("melee" = 30, "bullet" = 20, "laser" = 20, "energy" = 15, "bio" = 0, "rad" = 0, "fire" = 25, "acid" = 25, "wound" = 30)
...
/obj/item/clothing/suit/armor/light/leather/leathercoat
	...
	armor_list = list("melee" = 35, "bullet" = 22, "laser" = 22, "energy" = 15, "bomb" = 45, "bio" = 30, "rad" = 5, "fire" = 50, "acid" = 35, "wound" = 35)
...
/obj/item/clothing/suit/armor/light/kit
	...
	armor_list = list("melee" = 30, "bullet" = 30, "laser" = 30, "energy" = 20, "bomb" = 25, "bio" = 0, "rad" = 0, "fire" = 10, "acid" = 0, "wound" = 30)
	strip_delay = 30
	slowdown = 0.025
...
/obj/item/clothing/suit/armor/light/kit/punk
	...
	armor_list = list("melee" = 20, "bullet" = 40, "laser" = 15, "energy" = 15, "bio" = 0, "rad" = 0, "fire" = 10, "acid" = 0, "wound" = 30)
	strip_delay = 30
...
/obj/item/clothing/suit/armor/medium/vest/breastplate/light
	...
	inhand_icon_state = "armorkit"
	armor_list = list("melee" = 33, "bullet" = 33, "laser" = 40, "energy" = 15, "bomb" = 20, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 0)
	slowdown = 0.08
...
/obj/item/clothing/suit/armor/light/leather
	...
	armor_list = list("melee" = 35, "bullet" = 20, "laser" = 35, "energy" = 25, "bomb" = 32, "bio" = 0, "rad" = 10, "fire" = 30, "acid" = 35, "wound" = 30)
	strip_delay = 40
	slowdown = 0.06
...
/obj/item/clothing/suit/armor/light/leather/leathermk2
	...
	armor_list = list("melee" = 37, "bullet" = 22, "laser" = 37, "energy" = 27, "bomb" = 35, "bio" = 0, "rad" = 15, "fire" = 40, "acid" = 35, "wound" = 35)
	slowdown = 0.08
...
/obj/item/clothing/suit/armor/heavy/metal
	...
	armor_list = list("melee" = 40, "bullet" = 45, "laser" = 50, "energy" = 15, "bomb" = 45, "bio" = 30, "rad" = 15, "fire" = 60, "acid" = 0, "wound" = 45)
	slowdown = 0.22
	strip_delay = 10
...
/obj/item/clothing/suit/armor/heavy/metal/polished
	...
	armor_list = list("melee" = 38, "bullet" = 38, "laser" = 72, "energy" = 25, "bomb" = 45, "bio" = 30, "rad" = 15, "fire" = 60, "acid" = 0, "wound" = 45)
	slowdown = 0.2
	strip_delay = 10
...
/obj/item/clothing/suit/armor/heavy/metal/reinforced
	...
	armor_list = list("melee" = 45, "bullet" = 50, "laser" = 55, "energy" = 15, "bomb" = 45, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0, "wound" = 50)
	slowdown = 0.25
	strip_delay = 10
...
/obj/item/clothing/suit/armor/medium/vest/breastplate
	...
	armor_list = list("melee" = 20, "bullet" = 45, "laser" = 50, "energy" = 15, "bomb" = 20, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0, "wound" = 40)
	slowdown = 0.06
	strip_delay = 5
...
/obj/item/clothing/suit/armor/medium/combat/laserproof
	...
	armor_list = list("melee" = 35, "bullet" = 35, "laser" = 60, "energy" = 50, "bomb" = 50, "bio" = 60, "rad" = 10, "fire" = 60, "acid" = 20, "wound" = 50)
...
/obj/item/clothing/suit/armor/heavy/riot/combat
	...
	armor_list = list("melee" = 55, "bullet" = 55, "laser" = 45, "energy" = 35, "bomb" = 30, "bio" = 0, "rad" = 0, "fire" = 5, "acid" = 35, "wound" = 45)
	slowdown = 0.15
...
/obj/item/clothing/suit/armor/medium/combat/swat
	...
	armor_list = list("melee" = 35, "bullet" = 50, "laser" = 40, "energy" = 25, "bomb" = 55, "bio" = 60, "rad" = 15, "fire" = 60, "acid" = 30, "wound" = 55)
...
/obj/item/clothing/suit/armor/medium/combat/rusted
	...
	armor_list = list("melee" = 38, "bullet" = 45, "laser" = 38, "energy" = 18, "bomb" = 45, "bio" = 55, "rad" = 10, "fire" = 60, "acid" = 20, "wound" = 45)
	slowdown = 0.12
...
/obj/item/clothing/suit/armor/medium/combat/environmental
	...
	armor_list = list("melee" = 35, "bullet" = 40, "laser" = 40,"energy" = 20, "bomb" = 55, "bio" = 70, "rad" = 100, "fire" = 60, "acid" = 50)
	strip_delay = 60
...
/obj/item/clothing/suit/armor/medium/combat/mk2/raider
	...
	armor_list = list("melee" = 35, "bullet" = 40, "laser" = 40, "energy" = 35, "bomb" = 50, "bio" = 60, "rad" = 10, "fire" = 60, "acid" = 20, "wound" = 45)
	slowdown = 0.05
...
/obj/item/clothing/suit/armor/power_armor/t45b
	...
	armor_list = list("melee" = 70, "bullet" = 70, "laser" = 70, "energy" = 22, "bomb" = 55, "bio" = 65, "rad" = 55, "fire" = 85, "acid" = 0, "wound" = 65)
	slowdown = 0.4
...
/obj/item/clothing/suit/armor/power_armor/t45d
	...
	slowdown = 0.25
	armor_list = list("melee" = 72.5, "bullet" = 72.5, "laser" = 72.5, "energy" = 25, "bomb" = 65, "bio" = 75, "rad" = 80, "fire" = 85, "acid" = 30, "wound" = 70)
...
/obj/item/clothing/suit/armor/power_armor/t51b
	...
	armor_list = list("melee" = 72.5, "bullet" = 72.5, "laser" = 72.5, "energy" = 30, "bomb" = 62, "bio" = 100, "rad" = 99, "fire" = 90, "acid" = 40, "wound" = 72)
...
/obj/item/clothing/suit/armor/power_armor/t51b/hardened
	...
	slowdown = 0.25 //+0.05 from helmet = total 0.255
	armor_list = list("melee" = 75, "bullet" = 75, "laser" = 75, "energy" = 27, "bomb" = 64, "bio" = 100, "rad" = 99, "fire" = 90, "acid" = 40, "wound" = 75)
...
/obj/item/clothing/suit/armor/power_armor/t60
	...
	slowdown = 0.2
	armor_list = list("melee" = 80, "bullet" = 70, "laser" = 80, "energy" = 30, "bomb" = 82, "bio" = 100, "rad" = 100, "fire" = 95, "acid" = 50, "wound" = 80)
...
/obj/item/clothing/suit/armor/power_armor/t60/pineapple
	...
	armor_list = list("melee" = 45, "bullet" = 45, "laser" = 45, "energy" = 60, "bomb" = 50, "bio" = 60, "rad" = 10, "fire" = 60, "acid" = 20, "wound" = 50)
	salvaged_type = null
...
/obj/item/clothing/suit/armor/power_armor/excavator
	...
	slowdown = 0.4
	armor_list = list("melee" = 80, "bullet" = 50, "laser" = 50, "energy" = 15, "bomb" = 100, "bio" = 100, "rad" = 100, "fire" = 95, "acid" = 80, "wound" = 80)
...
/obj/item/clothing/suit/armor/power_armor/advanced
	...
	armor_list = list("melee" = 80, "bullet" = 80, "laser" = 85, "energy" = 35, "bomb" = 72, "bio" = 100, "rad" = 100, "fire" = 90, "acid" = 50, "wound" = 90)
...
/obj/item/clothing/suit/armor/power_armor/advanced/x02
	...
	armor_list = list("melee" = 85, "bullet" = 85, "laser" = 85, "energy" = 65, "bomb" = 70, "bio" = 100, "rad" = 100, "fire" = 90, "acid" = 50, "wound" = 75)
...
/obj/item/clothing/suit/hooded/outcast/tribal
	...
	armor_list = list("melee" = 40, "bullet" = 30, "laser" = 5, "energy" = 0, "bomb" = 10, "bio" = 0, "rad" = 0, "fire" = 10, "acid" = 0)
	strip_delay = 40
...
/obj/item/clothing/suit/armor/light/tribal
	...
	armor_list = list("melee" = 55, "bullet" = 35,"laser" = 20, "energy" = 0, "bomb" = 10, "bio" = 0, "rad" = 0, "fire" = 10, "acid" = 0)
	flags_inv = HIDEJUMPSUIT
	strip_delay = 40
	icon = 'icons/fallout/clothing/armored_light.dmi'
	mob_overlay_icon = 'icons/fallout/onmob/clothes/armor_light.dmi'
...
/obj/item/clothing/suit/armor/heavy/metal/tesla //changed from armor/laserproof
	...
	armor_list = list("melee" = 25, "bullet" = 25,"laser" = 99, "energy" = 60, "bomb" = 40, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0)
...
/obj/item/clothing/suit/armor/heavy/metal/sulphite
	...
	armor_list = list("melee" = 25, "bullet" = 55,"laser" = 40, "energy" = 20, "bomb" = 50, "bio" = 60, "rad" = 10, "fire" = 60, "acid" = 20, "wound" = 45)
	slowdown = 0.20
...
/obj/item/clothing/suit/armor/vaquero
	...
	armor_list = list("melee" = 30, "bullet" = 25,"laser" = 25, "energy" = 10, "bomb" = 15, "bio" = 0, "rad" = 0, "fire" = 30, "acid" = 0)
	flags_inv = HIDEJUMPSUIT
...
/obj/item/clothing/suit/armor/light/wastewar
	...
	armor_list = list("melee" = 35, "bullet" = 25, "laser" = 25, "energy" = 10, "bomb" = 15, "bio" = 0, "rad" = 0, "fire" = 30, "acid" = 0, "wound" = 35)
	slowdown = 0.07
...
/obj/item/clothing/suit/armor/medium/raider/slam
	...
	armor_list = list("melee" = 45, "bullet" = 20,"laser" = 20, "energy" = 0, "bomb" = 10, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 0)
	flags_inv = HIDEJUMPSUIT
	strip_delay = 40
	icon = 'icons/fallout/clothing/armored_medium.dmi'
	mob_overlay_icon = 'icons/fallout/onmob/clothes/armor_medium.dmi'
...
/obj/item/clothing/suit/armor/light/duster/battlecoat //Maxson's battlecoat from Fallout 4
	...
	armor_list = list("melee" = 30, "bullet" = 20,"laser" = 20, "energy" = 20, "bomb" = 30, "bio" = 0, "rad" = 30, "fire" = 30, "acid" = 30, "wound" = 35)
	strip_delay = 30
	icon = 'icons/fallout/clothing/armored_light.dmi'
	mob_overlay_icon = 'icons/fallout/onmob/clothes/armor_light.dmi'
	pocket_storage_component_path = /datum/component/storage/concrete/pockets
...
/obj/item/clothing/suit/armor/light/duster/brahmin
	...
	armor_list = list("melee" = 25, "bullet" = 25, "laser" = 35, "energy" = 35, "bomb" = 35, "bio" = 40, "rad" = 10, "fire" = 60, "acid" = 10, "wound" = 40)
	pocket_storage_component_path = /datum/component/storage/concrete/pockets
...
/obj/item/clothing/suit/armor/light/duster/rustedcowboy
	...
	armor_list = list("melee" = 25, "bullet" = 25, "laser" = 35, "energy" = 35, "bomb" = 35, "bio" = 40, "rad" = 10, "fire" = 60, "acid" = 10)
...
/obj/item/clothing/suit/armor/heavy/vest/bulletproof
	...
	blood_overlay_type = "armor"
	armor_list = list("melee" = 27, "bullet" = 60, "laser" = 27, "energy" = 35, "bomb" = 50, "bio" = 40, "rad" = 10, "fire" = 60, "acid" = 10, "wound" = 50)
	strip_delay = 70
...
/obj/item/clothing/suit/armor/light/tribal/bone/cool
	...
	blood_overlay_type = "armor"
	armor_list = list("melee" = 65, "bullet" = 5, "laser" = 0, "energy" = 10, "bomb" = 25, "bio" = 0, "rad" = 0, "fire" = 50, "acid" = 50, "wound" = 45)
...
/obj/item/clothing/suit/armor/medium/duster/follower
	...
	armor_list = list("melee" = 30, "bullet" = 25, "laser" = 25, "energy" = 35, "bomb" = 30, "bio" = 0, "rad" = 0, "fire" = 25, "acid" = 25)
	strip_delay = 40
...
/obj/item/clothing/suit/toggle/armor/rangercustomdark
	...
	armor_list = list("melee" = 30, "bullet" = 25, "laser" = 25, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0)
...
/obj/item/clothing/suit/donor/soldier
	...
	armor_list = list("melee" = 30, "bullet" = 33, "laser" = 25, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0)
	pocket_storage_component_path = /datum/component/storage/concrete/pockets
...
/obj/item/clothing/suit/armor/light/duster/herbertranger //Armor wise, it's reskinned raider armor.
	...
	armor_list = list("melee" = 30, "bullet" = 30, "laser" = 25, "energy" = 10, "bomb" = 15, "bio" = 60, "rad" = 15, "fire" = 60, "acid" = 30)
	strip_delay = 40
...
/obj/item/clothing/suit/armor/atomzealot
	...
	armor_list = list("melee" = 25, "bullet" = 25, "laser" = 25, "energy" = 20, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 10, "acid" = 10)
...
/obj/item/clothing/suit/armor/harbingermantle
	...
	armor_list = list("melee" = 45, "bullet" = 45, "laser" = 45, "energy" = 20, "bomb" = 50, "bio" = 40, "rad" = 10, "fire" = 60, "acid" = 10)
...
/obj/item/clothing/suit/armor/medium/duster/mutant
	...
	armor_list = list("melee" = 35, "bullet" = 25, "laser" = 35, "energy" = 15, "bomb" = 50, "bio" = 40, "rad" = 10, "fire" = 60, "acid" = 10, "wound" = 40)
...
/obj/item/clothing/suit/armor/heavy/metal/mutant
	...
	armor_list = list("melee" = 35, "bullet" = 35, "laser" = 15, "energy" = 10, "bomb" = 50, "bio" = 40, "rad" = 10, "fire" = 60, "acid" = 10)
...
/obj/item/clothing/suit/armor/light/tribal
	...
	armor_list = list("melee" = 25, "bullet" = 25, "laser" = 25, "energy" = 10, "bomb" = 50, "bio" = 40, "rad" = 10, "fire" = 60, "acid" = 10)
	slowdown = 0.025
...
/obj/item/clothing/suit/armor/medium/tribal
	...
	armor_list = list("melee" = 37, "bullet" = 40, "laser" = 37, "energy" = 25, "bomb" = 50, "bio" = 40, "rad" = 10, "fire" = 60, "acid" = 10)
	slowdown = 0.1
...
/obj/item/clothing/suit/armor/light/tribal/ncr
	...
	armor_list = list("melee" = 25, "bullet" = 35, "laser" = 15, "energy" = 10, "bomb" = 50, "bio" = 40, "rad" = 10, "fire" = 60, "acid" = 10)
...
/obj/item/clothing/suit/armor/light/tribal/rustwalkers
	...
	armor_list = list("melee" = 35, "bullet" = 40, "laser" = 35, "energy" = 10, "bomb" = 50, "bio" = 40, "rad" = 10, "fire" = 60, "acid" = 10)
...
/obj/item/clothing/suit/armor/medium/tribal/eighties
	...
	armor_list = list("melee" = 35, "bullet" = 45, "laser" = 25, "energy" = 20, "bomb" = 50, "bio" = 40, "rad" = 10, "fire" = 60, "acid" = 10)
	slowdown = 0.1
...
/obj/item/clothing/suit/armor/light/tribal/deadhorses
	...
	pocket_storage_component_path = /datum/component/storage/concrete/pockets/bulletbelt
	armor_list = list("melee" = 25, "bullet" = 20, "laser" = 20, "energy" = 10, "bomb" = 50, "bio" = 40, "rad" = 10, "fire" = 60, "acid" = 10)
	slowdown = 0.01
...
/obj/item/clothing/suit/armor/light/tribal/deadhorses
	...
	pocket_storage_component_path = /datum/component/storage/concrete/pockets/bulletbelt
	armor_list = list("melee" = 35, "bullet" = 25, "laser" = 25, "energy" = 10, "bomb" = 50, "bio" = 40, "rad" = 10, "fire" = 60, "acid" = 10)
	slowdown = 0.025
...
/obj/item/clothing/suit/armor/medium/tribal/deadhorses
	...
	pocket_storage_component_path = /datum/component/storage/concrete/pockets/bulletbelt
	armor_list = list("melee" = 35, "bullet" = 35, "laser" = 30, "energy" = 10, "bomb" = 50, "bio" = 40, "rad" = 10, "fire" = 60, "acid" = 10)
	slowdown = 0.05
...
/obj/item/clothing/suit/armor/light/tribal/sorrows
	...
	armor_list = list("melee" = 20, "bullet" = 45, "laser" = 20, "energy" = 10, "bomb" = 50, "bio" = 40, "rad" = 10, "fire" = 60, "acid" = 10)
	slowdown = 0.08
...
/obj/item/clothing/suit/armor/light/tribal/bone
	...
	blood_overlay_type = "armor"
	armor_list = list("melee" = 30, "bullet" = 25, "laser" = 25, "energy" = 10, "bomb" = 50, "bio" = 40, "rad" = 10, "fire" = 60, "acid" = 10)
	pocket_storage_component_path = /datum/component/storage/concrete/pockets
	body_parts_covered = CHEST|GROIN|LEGS|FEET|ARMS
...
/obj/item/clothing/suit/armor/light/tribal/bone
	...
	blood_overlay_type = "armor"
	armor_list = list("melee" = 40, "bullet" = 35, "laser" = 30, "energy" = 10, "bomb" = 50, "bio" = 40, "rad" = 10, "fire" = 60, "acid" = 10)
	pocket_storage_component_path = /datum/component/storage/concrete/pockets/small
	body_parts_covered = CHEST|GROIN|LEGS|FEET|ARMS
	slowdown = 0.025
...
/obj/item/clothing/suit/armor/medium/tribal/bone
	...
	blood_overlay_type = "armor"
	armor_list = list("melee" = 45, "bullet" = 45, "laser" = 35, "energy" = 20, "bomb" = 50, "bio" = 40, "rad" = 10, "fire" = 60, "acid" = 10, "wound" = 45)
	pocket_storage_component_path = /datum/component/storage/concrete/pockets/small
	body_parts_covered = CHEST|GROIN|LEGS|FEET|ARMS
	slowdown = 0.05
...
/obj/item/clothing/suit/armor/medium/tribal/westernwayfarer
	...
	armor_list = list("melee" = 37, "bullet" = 40, "laser" = 25, "energy" = 20, "bomb" = 50, "bio" = 40, "rad" = 10, "fire" = 60, "acid" = 10)
	pocket_storage_component_path = /datum/component/storage/concrete/pockets/small
