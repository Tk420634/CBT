...
/obj/item/clothing/suit/armor/outfit/overalls/farmer
	...
	armor_list = list("melee" = 15, "bullet" = 10, "laser" = 10, "energy" = 0, "bomb" = 16, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 0)
...
/obj/item/clothing/suit/armor/outfit/vest
	...
	armor_list = list("melee" = 25, "bullet" = 15, "laser" = 15, "energy" = 5, "bomb" = 16, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 0)
...
/obj/item/clothing/suit/armor/outfit/jacket/mfp //Mad Max 1 1979 babe!
	...
	icon_state = "mfp"
	inhand_icon_state = "hostrench"
	armor_list = list("melee" = 25, "bullet" = 20, "laser" = 15, "energy" = 5, "bomb" = 16, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 0)
...
/obj/item/clothing/suit/armor/light/duster/autumn //Based of Colonel Autumn's uniform.
	...
	body_parts_covered = CHEST|GROIN|LEGS|FEET|ARMS
	armor_list = list("melee" = 30, "bullet" = 30, "laser" = 15, "energy" = 5, "bomb" = 16, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 0)
...
/obj/item/clothing/suit/bio_suit/hazmat
	...
	armor_list = list("melee" = 20, "bullet" = 10, "laser" = 30, "energy" = 25, "bomb" = 16, "bio" = 100, "rad" = 100, "fire" = 0, "acid" = 0)
...
/obj/item/clothing/head/bio_hood/hazmat
	...
	armor_list = list("melee" = 29, "bullet" = 10, "laser" = 30, "energy" = 25, "bomb" = 16, "bio" = 100, "rad" = 100, "fire" = 0, "acid" = 0)
...
/obj/item/clothing/suit/toggle/labcoat/warriors
	...
	armor_list = list("melee" = 25, "bullet" = 10, "laser" = 30, "energy" = 25, "bomb" = 16, "bio" = 0, "rad" = 10, "fire" = 0, "acid" = 0)
...
/obj/item/clothing/suit/toggle/labcoat/wanderer
	...
	icon_state = "wanderer"
	inhand_icon_state = "owl"
	armor_list = list("melee" = 25, "bullet" = 10, "laser" = 30, "energy" = 25, "bomb" = 16, "bio" = 10, "rad" = 0, "fire" = 0, "acid" = 0)
...
/obj/item/clothing/suit/toggle/labcoat/khan_jacket
	...
	armor_list = list("melee" = 30, "bullet" = 30, "laser" = 30, "energy" = 20, "bomb" = 30, "bio" = 10, "rad" = 10, "fire" = 10, "acid" = 0, "wound" = 30)
	slowdown = 0.05
	pocket_storage_component_path = /datum/component/storage/concrete/pockets
...
/obj/item/clothing/suit/toggle/labcoat/khan_jacket/armored
	...
	body_parts_covered = CHEST|GROIN|ARMS|LEGS|HANDS|FEET
	armor_list = list("melee" = 37, "bullet" = 37, "laser" = 40, "energy" = 25, "bomb" = 30, "bio" = 10, "rad" = 10, "fire" = 10, "acid" = 0, "wound" = 30)
	slowdown = 0.08
	pocket_storage_component_path = /datum/component/storage/concrete/pockets/small
...
/obj/item/clothing/suit/toggle/labcoat/khan_jacket/coat
	...
	body_parts_covered = CHEST|GROIN|ARMS|LEGS|HANDS|FEET
	armor_list = list("melee" = 40, "bullet" = 40, "laser" = 47, "energy" = 25, "bomb" = 35, "bio" = 10, "rad" = 10, "fire" = 10, "acid" = 0, "wound" = 40)
	pocket_storage_component_path = /datum/component/storage/concrete/pockets/small
	slowdown = 0.3
...
/obj/item/clothing/suit/toggle/labcoat/followers
	...
	armor_list = list("melee" = 25, "bullet" = 15, "laser" = 20, "energy" = 25, "bomb" = 20, "bio" = 100, "rad" = 100, "fire" = 0, "acid" = 0)
...
/obj/item/clothing/suit/armor/generaluniform
	...
	armor_list = list("melee" = 25, "bullet" = 15, "laser" = 20, "energy" = 25, "bomb" = 20, "bio" = 100, "rad" = 100, "fire" = 0, "acid" = 0)	//change those values
...
/obj/item/clothing/suit/hooded/cloak/goliath
	...
	body_parts_covered = CHEST|GROIN|LEGS|FEET|ARMS|HANDS
	slowdown = 0.07
	armor_list = list("melee" = 40, "bullet" = 20, "laser" = 40, "energy" = 25, "bomb" = 16, "bio" = 10, "rad" = 10, "fire" = 0, "acid" = 0)
...
/obj/item/clothing/suit/hooded/cloak/drake //SS13 item, obviously
	...
	armor_list = list("melee" = 40, "bullet" = 40, "laser" = 40, "energy" = 25, "bomb" = 16, "bio" = 10, "rad" = 10, "fire" = 0, "acid" = 0)
...
/obj/item/clothing/suit/hooded/cloak/shunter
	...
	body_parts_covered = CHEST|GROIN|LEGS|ARMS|HANDS
	resistance_flags = FIRE_PROOF | ACID_PROOF
	armor_list = list("melee" = 40, "bullet" = 40, "laser" = 35, "energy" = 20, "bomb" = 25, "bio" = 0, "rad" = 0, "fire" = 10, "acid" = 0, "wound" = 30)
