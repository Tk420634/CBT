...
/obj/item/clothing/suit/armor/heavy/metal/sulphite
	...
	armor_list = list("melee" = 55, "bullet" = 40, "laser" = 50, "energy" = 50, "bomb" = 30, "bio" = 25, "rad" = 30, "fire" = 95, "acid" = 15)
...
/obj/item/clothing/suit/armor/heavy/metal
	...
	armor_list = list("melee" = 60, "bullet" = 45, "laser" = 30, "energy" = 20, "bomb" = 30, "bio" = 10, "rad" = 25, "fire" = 20, "acid" = 20)
...
/obj/item/clothing/suit/armor/heavy/salvaged_pa/recycled
	...
	armor_list = list("melee" = 50, "bullet" = 45, "laser" = 30, "energy" = 25, "bomb" = 35, "bio" = 5, "rad" = 15, "fire" = 15, "acid" = 5)
...
/obj/item/clothing/suit/armor/heavy/metal/raider
	...
	icon_state = "raider_metal"
	inhand_icon_state = "raider_metal"
	armor_list = list("melee" = 55, "bullet" = 40, "laser" = 15, "energy" = 10, "bomb" = 25, "bio" = 0, "rad" = 15, "fire" = 20, "acid" = 0)
...
/obj/item/clothing/suit/armor/heavy/wardenplate
	...
	armor_list = list("melee" = 55, "bullet" = 50, "laser" = 35, "energy" = 25, "bomb" = 30, "bio" = 0, "rad" = 15, "fire" = 10, "acid" = 10)
...
/obj/item/clothing/suit/armor/heavy/bosexile
	...
	armor_list = list("melee" = 30, "bullet" = 40, "laser" = 40, "energy" = 20, "bomb" = 25, "bio" = 10, "rad" = 10, "fire" = 20, "acid" = 10)
...
/obj/item/clothing/suit/armor/heavy/riot
	...
	armor_list = list("melee" = 70, "bullet" = 45, "laser" = 20, "energy" = 20, "bomb" = 45, "bio" = 35, "rad" = 10, "fire" = 50, "acid" = 10)
...
/obj/item/clothing/suit/armor/heavy/tribal
	...
	armor_list = list("melee" = 55, "bullet" = 20, "laser" = 25, "energy" = 20, "bomb" = 45, "bio" = 5, "rad" = 10, "fire" = 30, "acid" = 10)
...
/obj/item/clothing/suit/armor/heavy/salvaged_pa/t45b
	...
	armor_list = list("melee" = 65, "bullet" = 65, "laser" = 55, "energy" = 15, "bomb" = 45, "bio" = 60, "rad" = 30, "fire" = 60, "acid" = 20, "wound" = 30)
...
/obj/item/clothing/suit/armor/heavy/salvaged_pa/t45b/raider
	...
	armor_list = list("melee" = 60, "bullet" = 60, "laser" = 50, "energy" = 15, "bomb" = 40, "bio" = 55, "rad" = 25, "fire" = 55, "acid" = 15, "wound" = 25)
...
/obj/item/clothing/suit/armor/heavy/salvaged_pa/t45b/hotrod
	...
	armor_list = list("melee" = 55, "bullet" = 55, "laser" = 55, "energy" = 10, "bomb" = 40, "bio" = 50, "rad" = 30, "fire" = 80, "acid" = 10, "wound" = 30)
...
/obj/item/clothing/suit/armor/heavy/salvaged_pa/t45b/tribal
	...
	armor_list = list("melee" = 65, "bullet" = 55, "laser" = 55, "energy" = 10, "bomb" = 30, "bio" = 40, "rad" = 20, "fire" = 40, "acid" = 0, "wound" = 25)
...
/obj/item/clothing/suit/armor/heavy/salvaged_pa/t45d
	...
	armor_list = list("melee" = 70, "bullet" = 70, "laser" = 60, "energy" = 15, "bomb" = 45, "bio" = 65, "rad" = 40, "fire" = 70, "acid" = 25, "wound" = 40)
	slowdown = 0.85
...
/obj/item/clothing/suit/armor/heavy/salvaged_pa/t51b
	...
	armor_list = list("melee" = 70, "bullet" = 70, "laser" = 60, "energy" = 20, "bomb" = 45, "bio" = 70, "rad" = 50, "fire" = 75, "acid" = 35, "wound" = 40)
	slowdown = 0.85
...
/obj/item/clothing/suit/armor/heavy/salvaged_pa/midwest/hardened
	...
	armor_list = list("melee" = 70, "bullet" = 70, "laser" = 65, "energy" = 20, "bomb" = 50, "bio" = 80, "rad" = 60, "fire" = 80, "acid" = 35, "wound" = 50)
	slowdown = 0.85
...
/obj/item/clothing/suit/armor/heavy/salvaged_pa/t60
	...
	armor_list = list("melee" = 75, "bullet" = 70, "laser" = 65, "energy" = 30, "bomb" = 55, "bio" = 70, "rad" = 60, "fire" = 80, "acid" = 35, "wound" = 45)
	slowdown = 0.8
...
/obj/item/clothing/suit/armor/heavy/salvaged_pa/x02
	...
	armor_list = list("melee" = 80, "bullet" = 80, "laser" = 70, "energy" = 35, "bomb" = 60, "bio" = 70, "rad" = 65, "fire" = 85, "acid" = 45, "wound" = 50)
	slowdown = 0.85
...
/obj/item/clothing/suit/armor/heavy/legion/breacher
	...
	armor_list = list("melee" = 65, "bullet" = 45, "laser" = 30, "energy" = 20, "bomb" = 30, "bio" = 20, "rad" = 25, "fire" = 30, "acid" = 5)
...
/obj/item/clothing/suit/armor/heavy/legion/centurion
	...
	armor_list = list("melee" = 70, "bullet" = 50, "laser" = 35, "energy" = 35, "bomb" = 40, "bio" = 30, "rad" = 25, "fire" = 40, "acid" = 10)
...
/obj/item/clothing/suit/armor/heavy/legion/palacent
	...
	armor_list = list("melee" = 70, "bullet" = 60, "laser" = 50, "energy" = 40, "bomb" = 45, "bio" = 30, "rad" = 30, "fire" = 50, "acid" = 20)
...
/obj/item/clothing/suit/armor/heavy/legion/rangercent
	...
	armor_list = list("melee" = 65, "bullet" = 50, "laser" = 30, "energy" = 30, "bomb" = 35, "bio" = 30, "rad" = 25, "fire" = 50, "acid" = 10)
	slowdown = 0.05
...
/obj/item/clothing/suit/armor/heavy/legion/legate
	...
	armor_list = list("melee" = 70, "bullet" = 60, "laser" = 45, "energy" = 45, "bomb" = 45, "bio" = 50, "rad" = 30, "fire" = 70, "acid" = 20)
...
/obj/item/clothing/suit/armor/heavy/eliteriot
	...
	armor_list = list("melee" = 70, "bullet" = 60, "laser" = 40, "energy" = 35, "bomb" = 45, "bio" = 40, "rad" = 30, "fire" = 50, "acid" = 0)
...
/obj/item/clothing/suit/armor/heavy/tesla
	...
	armor_list = list("melee" = 35, "bullet" = 35, "laser" = 60, "energy" = 60, "bomb" = 35, "bio" = 0, "rad" = 0, "fire" = 100, "acid" = 90)
	resistance_flags = FIRE_PROOF
...
/obj/item/clothing/suit/armor/heavy/salvagedpowerarmor
	...
	icon_state = "tribal_power_armor"
	inhand_icon_state = "tribal_power_armor"
	armor_list = list("melee" = 65, "bullet" = 65, "laser" = 45, "energy" = 40, "bomb" = 45, "bio" = 30, "rad" = 30, "fire" = 60, "acid" = 10)
	allowed = list(/obj/item/twohanded, /obj/item/melee/onehanded, /obj/item/melee/smith, /obj/item/melee/smith/twohand)
...
/obj/item/clothing/suit/armor/heavy/environmental
	...
	armor_list = list("melee" = 35, "bullet" = 30, "laser" = 20, "energy" = 15, "energy" = 45, "bomb" = 55, "bio" = 70, "rad" = 100, "fire" = 60, "acid" = 50)
