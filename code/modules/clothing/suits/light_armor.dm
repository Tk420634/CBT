...
/obj/item/clothing/suit/armor/light/duster
	...
	armor_list = list("melee" = 15, "bullet" = 20, "laser" = 10, "energy" = 10, "bomb" = 15, "bio" = 10, "rad" = 0, "fire" = 20, "acid" = 5)
...
/obj/item/clothing/suit/armor/light/duster/lonesome
	...
	armor_list = list("melee" = 25, "bullet" = 30, "laser" = 25, "energy" = 25, "bomb" = 25, "bio" = 5, "rad" = 15, "fire" = 20, "acid" = 10)
...
/obj/item/clothing/suit/armor/light/duster/autumn //Based of Colonel Autumn's uniform.
	...
	armor_list = list("melee" = 15, "bullet" = 15, "laser" = 20, "energy" = 20, "bomb" = 20, "bio" = 5, "rad" = 0, "fire" = 15, "acid" = 5)
...
/obj/item/clothing/suit/armor/light/duster/battlecoat
	...
	armor_list = list("melee" = 10, "bullet" = 10, "laser" = 25, "energy" = 25, "bomb" = 10, "bio" = 5, "rad" = 10, "fire" = 25, "acid" = 5)
...
/obj/item/clothing/suit/armor/light/duster/vet
	...
	armor_list = list("melee" = 20, "bullet" = 20, "laser" = 10, "energy" = 10, "bomb" = 20, "bio" = 0, "rad" = 5, "fire" = 10, "acid" = 5)
...
/obj/item/clothing/suit/armor/light/duster/brahmin
	...
	armor_list = list("melee" = 14, "bullet" = 14, "laser" = 25, "energy" = 20, "bomb" = 10, "bio" = 5, "rad" = 0, "fire" = 25, "acid" = 5)
...
/obj/item/clothing/suit/armor/medium/vest/flak
	...
	armor_list = list("melee" = 0, "bullet" = 30, "laser" = 0, "energy" = 0, "bomb" = 15, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = -50)
...
/obj/item/clothing/suit/armor/medium/vest/kevlar
	...
	armor_list = list("melee" = 5, "bullet" = 35, "laser" = 5, "energy" = 0, "bomb" = 5, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 0)
...
/obj/item/clothing/suit/armor/medium/vest/bulletproof
	...
	armor_list = list("melee" = 10, "bullet" = 40, "laser" = 5, "energy" = 5, "bomb" = 10, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 0)
...
/obj/item/clothing/suit/armor/medium/vest/followers
	...
	armor_list = list("melee" = 10, "bullet" = 35, "laser" = 5, "energy" = 0, "bomb" = 5, "bio" = 10, "rad" = 0, "fire" = 5, "acid" = 0)
...
/obj/item/clothing/suit/armor/light/rustedcowboy
	...
	armor_list = list("melee" = 23, "bullet" = 20, "laser" = 15, "energy" = 15, "bomb" = 30, "bio" = 10, "rad" = 10, "fire" = 40, "acid" = 10,)
...
/obj/item/clothing/suit/armor/light/chitinarmor
	...
	permeability_coefficient = 0.5
	armor_list = list("melee" = 15, "bullet" = 15, "laser" = 20, "energy" = 20, "bomb" = 10, "bio" = 50, "rad" = 50, "fire" = 70, "acid" = 80)
...
/obj/item/clothing/suit/armor/light/wastetribe
	...
	flags_inv = HIDEJUMPSUIT
	armor_list = list("melee" = 22, "bullet" = 5, "laser" = 10, "energy" = 10, "bomb" = 5, "bio" = 0, "rad" = 5, "fire" = 5, "acid" = 0)
...
/obj/item/clothing/suit/armor/light/vaquero
	...
	armor_list = list("melee" = 10, "bullet" = 10, "laser" = 30, "energy" = 25, "bomb" = 5, "bio" = 0, "rad" = 0, "fire" = 20, "acid" = 0)
...
/obj/item/clothing/suit/armor/light/wastewar
	...
	armor_list = list("melee" = 25, "bullet" = 5, "laser" = 0, "energy" = 0, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = -10, "acid" = 0)
...
/obj/item/clothing/suit/toggle/armored/khanlight
	...
	armor_list = list("melee" = 30, "bullet" = 20, "laser" = 15, "energy" = 10, "bomb" = 5, "bio" = 0, "rad" = 30, "fire" = 0, "acid" = 5)
...
/obj/item/clothing/suit/armor/light/badlands
	...
	heat_protection = CHEST | GROIN | LEGS| ARMS | HEAD
	armor_list = list("melee" = 25, "bullet" = 25, "laser" = 10, "energy" = 5, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 5, "acid" = 0)
...
/obj/item/clothing/suit/armor/light/tribalraider
	...
	heat_protection = CHEST | GROIN | LEGS| ARMS | HEAD
	armor_list = list("melee" = 30, "bullet" = 20, "laser" = 15, "energy" = 10, "bomb" = 5, "bio" = 0, "rad" = 0, "fire" = 15, "acid" = 0)
...
/obj/item/clothing/suit/hooded/outcast
	...
	armor_list = list("melee" = 35, "bullet" = 20, "laser" = 10, "energy" = 10, "bomb" = 25, "bio" = 20, "rad" = 30, "fire" = 30, "acid" = 20)
...
/obj/item/clothing/suit/armor/light/kit
	...
	heat_protection = CHEST | GROIN | LEGS| ARMS | HEAD
	siemens_coefficient = 1.1
	armor_list = list("melee" = 15, "bullet" = 25, "laser" = 10, "energy" = 5, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 0)
...
/obj/item/clothing/suit/armor/light/kit/punk
	...
	armor_list = list("melee" = 18, "bullet" = 22, "laser" = 10, "energy" = 5, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 0)
...
/obj/item/clothing/suit/armor/light/kit/shoulder
	...
	armor_list = list("melee" = 20, "bullet" = 20, "laser" = 7, "energy" = 5, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 0)
...
/obj/item/clothing/suit/armor/light/kit/plates
	...
	armor_list = list("melee" = 22, "bullet" = 27, "laser" = 10, "energy" = 5, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 0)
...
/obj/item/clothing/suit/armor/light/leather
	...
	armor_list = list("melee" = 23, "bullet" = 18, "laser" = 12, "energy" = 5, "bomb" = 5, "bio" = 0, "rad" = 0, "fire" = 5, "acid" = 0)
...
/obj/item/clothing/suit/armor/light/leathermk2
	...
	armor_list = list("melee" = 30, "bullet" = 25, "laser" = 12, "energy" = 5, "bomb" = 5, "bio" = 0, "rad" = 0, "fire" = 5, "acid" = 0)
...
/obj/item/clothing/suit/armor/light/leathersuit
	...
	armor_list = list("melee" = 20, "bullet" = 15, "laser" = 15, "energy" = 5, "bomb" = 5, "bio" = 5, "rad" = 0, "fire" = 15, "acid" = 5)
...
/obj/item/clothing/suit/armor/light/leather_jacket
	...
	armor_list = list("melee" = 15, "bullet" = 5, "laser" = 10, "energy" = 5, "bomb" = 0, "bio" = 5, "rad" = 0, "fire" = 5, "acid" = 0)
...
/obj/item/clothing/suit/armor/light/leather_jacketmk2
	...
	armor_list = list("melee" = 25, "bullet" = 10, "laser" = 10, "energy" = 10, "bomb" = 10, "bio" = 15, "rad" = 0, "fire" = 10, "acid" = 0)
...
/obj/item/clothing/suit/armor/light/leathercoat
	...
	cold_protection = CHEST | GROIN | LEGS| ARMS | HEAD
	armor_list = list("melee" = 25, "bullet" = 15, "laser" = 15, "energy" = 15, "bomb" = 15, "bio" = 20, "rad" = 10, "fire" = 15, "acid" = 5)
...
/obj/item/clothing/suit/armor/light/tanvest
	...
	armor_list = list("melee" = 18, "bullet" = 5, "laser" = 0, "energy" = 0, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 0)
...
/obj/item/clothing/suit/armor/light/cowboyvest
	...
	armor_list = list("melee" = 15, "bullet" = 10, "laser" = 10, "energy" = 5, "bomb" = 0, "bio" = 0, "rad" = 30, "fire" = 0, "acid" = 0)
...
/obj/item/clothing/suit/armor/light/town
	...
	armor_list = list("melee" = 20, "bullet" = 15, "laser" = 10, "energy" = 10, "bomb" = 15, "bio" = 10, "rad" = 0, "fire" = 20, "acid" = 5)

/obj/item/clothing/suit/armor/light/town/mayor
	name = "mayor trenchcoat"
	desc = "A symbol of the mayor's authority (or lack thereof)."
	armor_list = list("melee" = 25, "bullet" = 20, "laser" = 10, "energy" = 10, "bomb" = 15, "bio" = 10, "rad" = 0, "fire" = 20, "acid" = 5)
...
/obj/item/clothing/suit/armor/light/town/vest
	...
	icon_state = "vest_flak"
	inhand_icon_state = "vest_flak"
	armor_list = list("melee" = 10, "bullet" = 30, "laser" = 10, "energy" = 0, "bomb" = 20, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = -50)
...
/obj/item/clothing/suit/armor/light/tribal/legion/recruit
	...
	armor_list = list("melee" = 30, "bullet" = 25, "laser" = 10, "energy" = 10, "bomb" = 15, "bio" = 20, "rad" = 20, "fire" = 25, "acid" = 0)
...
/obj/item/clothing/suit/armor/light/tribal/legion/prime
	...
	armor_list = list("melee" = 30, "bullet" = 30, "laser" = 15, "energy" = 15, "bomb" = 25, "bio" = 20, "rad" = 20, "fire" = 25, "acid" = 0)
...
/obj/item/clothing/suit/armor/light/tribal/legion/explorer
	...
	armor_list = list("melee" = 30, "bullet" = 30, "laser" = 15, "energy" = 15, "bomb" = 20, "bio" = 20, "rad" = 20, "fire" = 25, "acid" = 0)
...
/obj/item/clothing/suit/toggle/armored/ranger_duster
	...
	armor_list = list("melee" = 12, "bullet" = 35, "laser" = 10, "energy" = 5, "bomb" = 5, "bio" = 10, "rad" = 10, "fire" = 15, "acid" = 0)
...
/obj/item/clothing/suit/armor/light/rangerrig
	...
	heat_protection = CHEST | GROIN | LEGS| ARMS | HEAD
	armor_list = list("melee" = 25, "bullet" = 25, "laser" = 20, "energy" = 10, "bomb" = 10, "bio" = 20, "rad" = 10, "fire" = 25, "acid" = 0)
...
/obj/item/clothing/suit/armor/light/tribal/cloak
	...
	armor_list = list("melee" = 30, "bullet" = 15, "laser" = 15, "energy" = 15, "bomb" = 15, "bio" = 5, "rad" = 15, "fire" = 25, "acid" = 5)
...
/obj/item/clothing/suit/armor/light/tribal/simple
	...
	armor_list = list("melee" = 30, "bullet" = 10, "laser" = 10, "energy" = 10, "bomb" = 15, "bio" = 5, "rad" = 5, "fire" = 20, "acid" = 0)
...
/obj/item/clothing/suit/hooded/cloak/birdclaw
	...
	slowdown = 0.025
	armor_list = list("melee" = 40, "bullet" = 30, "laser" = 20, "energy" = 20, "bomb" = 40, "bio" = 30, "rad" = 20, "fire" = 50, "acid" = 10)
...
/obj/item/clothing/suit/hooded/cloak/aethergiest
	...
	armor_list = list("melee" = 40, "bullet" = 30, "laser" = 20, "energy" = 20, "bomb" = 40, "bio" = 20, "rad" = 20, "fire" = 40, "acid" = 10)
...
/obj/item/clothing/suit/hooded/cloak/razorclaw
	...
	armor_list = list("melee" = 45, "bullet" = 35, "laser" = 25, "energy" = 25, "bomb" = 50, "bio" = 30, "rad" = 20, "fire" = 50, "acid" = 10)
...
/obj/item/clothing/head/hooded/cloakhood/razorclaw
	...
	armor_list = list("melee" = 45, "bullet" = 35, "laser" = 25, "energy" = 25, "bomb" = 50, "bio" = 30, "rad" = 25, "fire" = 50, "acid" = 10)
	heat_protection = HEAD
	resistance_flags = FIRE_PROOF | ACID_PROOF
