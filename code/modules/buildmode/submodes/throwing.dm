/datum/click_interceptor/buildmode_mode/throwing
	key = "throw"
	
	var/atom/movable/throw_atom = null
	
/datum/click_interceptor/buildmode_mode/throwing/Destroy()
	throw_atom = null
	return ..()

/datum/click_interceptor/buildmode_mode/throwing/show_help(client/c)
...
/datum/click_interceptor/buildmode_mode/throwing/handle_click(client/c, params, obj/object)
