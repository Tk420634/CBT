...
/obj/machinery/rnd/experimentor/Initialize()
	...
	trackedIan = locate(/mob/living/danimal/pet/dog/corgi/Ian) in GLOB.mob_living_list
	trackedRuntime = locate(/mob/living/danimal/pet/cat/Runtime) in GLOB.mob_living_list
	SetTypeReactions()
	...
	if(prob(EFFECT_PROB_VERYLOW-badThingCoeff) && loaded_item)
		...
		if(globalMalf > 16 && globalMalf < 35)
			...
			if(trackedIan)
				...
				new /mob/living/danimal/pet/dog/corgi(loc)
		...
		if(globalMalf > 51 && globalMalf < 75)
			...
			if(trackedRuntime)
				...
				new /mob/living/danimal/pet/cat(loc)
...
/obj/item/relic/proc/corgicannon(mob/user)
	...
	var/mob/living/danimal/pet/dog/corgi/C = new/mob/living/danimal/pet/dog/corgi(get_turf(user))
...
/obj/item/relic/proc/petSpray(mob/user)
	...
	var/counter
	var/list/valid_animals = list(/mob/living/danimal/parrot, /mob/living/danimal/butterfly, /mob/living/danimal/pet/cat, /mob/living/danimal/pet/dog/corgi, /mob/living/danimal/crab, /mob/living/danimal/pet/fox, /mob/living/danimal/hostile/lizard, /mob/living/danimal/mouse, /mob/living/danimal/pet/dog/pug, /mob/living/danimal/hostile/bear, /mob/living/danimal/hostile/poison/bees, /mob/living/danimal/hostile/carp)
