...
/mob/living/danimal/hostile/carp/adjustHealth(amount, updating_health = TRUE, forced = FALSE)
	. = ..()
	if(regen_amount)
		regen_cooldown = world.time + REGENERATION_DELAY

/mob/living/danimal/hostile/carp/BiologicalLife(seconds, times_fired)
	if(!(. = ..()))
		return
	if(regen_amount && regen_cooldown < world.time)
		heal_overall_damage(regen_amount)

/mob/living/danimal/hostile/carp/AttackingTarget()
	. = ..()
...
/mob/living/danimal/hostile/carp/holocarp
	icon_state = "holocarp"
...
/mob/living/danimal/hostile/carp/megacarp
...
/mob/living/danimal/hostile/carp/megacarp/Initialize()
	. = ..()
...
/mob/living/danimal/hostile/carp/cayenne
	name = "Cayenne"
