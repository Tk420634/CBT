/mob/living/danimal/hostile/netherworld
	name = "creature"
...
/mob/living/danimal/hostile/netherworld/migo
	name = "mi-go"
...
/mob/living/danimal/hostile/netherworld/migo/Initialize()
	. = ..()
...
/mob/living/danimal/hostile/netherworld/migo/say(message, bubble_type, list/spans = list(), sanitize = TRUE, datum/language/language = null, ignore_spam = FALSE, forced = null, only_overhead)
	..()
	if(stat)
		return
...
/mob/living/danimal/hostile/netherworld/migo/BiologicalLife(seconds, times_fired)
	if(!(. = ..()))
		return
	if(stat)
		return
...
/mob/living/danimal/hostile/netherworld/blankbody
	name = "blank body"
...
/obj/structure/spawner/nether
	...
	mob_types = list(/mob/living/danimal/hostile/netherworld/migo, /mob/living/danimal/hostile/netherworld, /mob/living/danimal/hostile/netherworld/blankbody)
	faction = list("nether")
...
/obj/structure/spawner/nether/process()
	for(var/mob/living/M in contents)
		if(M)
			...
			M.spawn_gibs()
			if(M.stat == DEAD)
				var/mob/living/danimal/hostile/netherworld/blankbody/blank
				blank = new(loc)
				blank.name = "[M]"
