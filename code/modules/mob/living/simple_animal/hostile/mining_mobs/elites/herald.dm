...
/mob/living/danimal/hostile/asteroid/elite/herald
	...
	var/mob/living/danimal/hostile/asteroid/elite/herald/mirror/my_mirror = null
	var/is_mirror = FALSE

/mob/living/danimal/hostile/asteroid/elite/herald/death()
	. = ..()
	if(!is_mirror)
...
/mob/living/danimal/hostile/asteroid/elite/herald/proc/become_ghost()
	icon_state = "herald_ghost"

/mob/living/danimal/hostile/asteroid/elite/herald/say(message, bubble_type, list/spans = list(), sanitize = TRUE, datum/language/language = null, ignore_spam = FALSE, forced = null, only_overhead)
	. = ..()
	if(.)
...
/mob/living/danimal/hostile/asteroid/elite/herald/OpenFire()
	if(client)
...
/mob/living/danimal/hostile/asteroid/elite/herald/proc/shoot_projectile(turf/marker, set_angle, is_teleshot)
...
/mob/living/danimal/hostile/asteroid/elite/herald/proc/herald_circleshot()
	var/static/list/directional_shot_angles = list(0, 45, 90, 135, 180, 225, 270, 315)
	for(var/i in directional_shot_angles)
		shoot_projectile(get_turf(src), i, FALSE)

/mob/living/danimal/hostile/asteroid/elite/herald/proc/unenrage()
...
/mob/living/danimal/hostile/asteroid/elite/herald/proc/herald_mirror()
	...
	if(my_mirror != null)
		qdel(my_mirror)
		my_mirror = null
	var/mob/living/danimal/hostile/asteroid/elite/herald/mirror/new_mirror = new /mob/living/danimal/hostile/asteroid/elite/herald/mirror(loc)
	my_mirror = new_mirror
	my_mirror.my_master = src
	my_mirror.faction = faction.Copy()

/mob/living/danimal/hostile/asteroid/elite/herald/mirror
	...
	del_on_death = TRUE
	is_mirror = TRUE
	var/mob/living/danimal/hostile/asteroid/elite/herald/my_master = null

/mob/living/danimal/hostile/asteroid/elite/herald/mirror/Initialize()
	..()
	toggle_ai(AI_OFF)

/mob/living/danimal/hostile/asteroid/elite/herald/mirror/Destroy()
	if(my_master != null)
...
/obj/item/projectile/herald/on_hit(atom/target, blocked = FALSE)
	...
	if(ismineralturf(target))
		...
		if(F != null && istype(F, /mob/living/danimal/hostile/asteroid/elite) && F.mob_faction_is_friendly_to_target(L))
