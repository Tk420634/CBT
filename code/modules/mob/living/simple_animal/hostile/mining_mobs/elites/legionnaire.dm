...
/mob/living/danimal/hostile/asteroid/elite/legionnaire
	...
	var/mob/living/danimal/hostile/asteroid/elite/legionnairehead/myhead = null
...
/mob/living/danimal/hostile/asteroid/elite/legionnaire/OpenFire()
	if(client)
...
/mob/living/danimal/hostile/asteroid/elite/legionnaire/proc/legionnaire_charge_2(move_dir, times_ran)
	if(times_ran >= 4)
		return
...
/mob/living/danimal/hostile/asteroid/elite/legionnaire/proc/head_detach(target)
	...
	if(has_head)
		...
		var/mob/living/danimal/hostile/asteroid/elite/legionnairehead/newhead = new /mob/living/danimal/hostile/asteroid/elite/legionnairehead(loc)
...
/mob/living/danimal/hostile/asteroid/elite/legionnaire/proc/onHeadDeath()
	myhead = null
	addtimer(CALLBACK(src,PROC_REF(regain_head)), 50)

/mob/living/danimal/hostile/asteroid/elite/legionnaire/proc/regain_head()
	has_head = TRUE
	if(stat == DEAD)
		return
	icon_state = "legionnaire"
...
/mob/living/danimal/hostile/asteroid/elite/legionnairehead
...
/obj/structure/legionnaire_bonfire
	...
	var/mob/living/danimal/hostile/asteroid/elite/legionnaire/myowner = null
...
/obj/item/crusher_trophy/legionnaire_spine/on_mark_detonation(mob/living/target, mob/living/user)
	if(!rand(1, 100) <= bonus_value || target.stat == DEAD)
		return
	var/mob/living/danimal/hostile/asteroid/hivelordbrood/legion/A = new /mob/living/danimal/hostile/asteroid/hivelordbrood/legion(user.loc)
