/mob/living/danimal/hostile/asteroid/hivelord
	name = "hivelord"
...
/mob/living/danimal/hostile/asteroid/hivelord/spawn_crusher_loot()
	loot += crusher_loot //we don't butcher

/mob/living/danimal/hostile/asteroid/hivelord/death(gibbed)
	mouse_opacity = MOUSE_OPACITY_ICON
	..(gibbed)

//A fragile but rapidly produced creature
/mob/living/danimal/hostile/asteroid/hivelordbrood
	name = "hivelord brood"
...
/mob/living/danimal/hostile/asteroid/hivelordbrood/Initialize()
	. = ..()
	if(swarming)
...
//Legion
/mob/living/danimal/hostile/asteroid/hivelord/legion
	name = "legion"
...
/mob/living/danimal/hostile/asteroid/hivelord/legion/random/Initialize()
	. = ..()
	if(prob(5))
		new /mob/living/danimal/hostile/asteroid/hivelord/legion/dwarf(loc)
		return INITIALIZE_HINT_QDEL

/mob/living/danimal/hostile/asteroid/hivelord/legion/dwarf
	name = "dwarf legion"
...
/mob/living/danimal/hostile/asteroid/hivelord/legion/beegion
	name = "beegion"
	desc = "You can still see what was once a human under the shifting mass of - oh my God, those are bees."
	brood_type = /mob/living/danimal/hostile/poison/bees/toxin

/mob/living/danimal/hostile/asteroid/hivelord/legion/death(gibbed)
	squirt_mob()
	..(gibbed)

/mob/living/danimal/hostile/asteroid/hivelord/legion/Destroy()
	squirt_mob()
	. = ..()

/mob/living/danimal/hostile/asteroid/hivelord/legion/proc/skull_vore(mob/living/prefbreak)
	if(!prefbreak)
		return
...
/mob/living/danimal/hostile/asteroid/hivelord/legion/proc/squirt_mob()
...
/mob/living/danimal/hostile/asteroid/hivelord/legion/tendril
	fromtendril = TRUE

//Legion skull
/mob/living/danimal/hostile/asteroid/hivelordbrood/legion
	name = "legion"
	desc = "One of many."
	icon = 'icons/mob/lavaland/lavaland_monsters.dmi'
...
/mob/living/danimal/hostile/asteroid/hivelordbrood/legion/BiologicalLife(seconds, times_fired)
	if(!(. = ..()))
		return
	if(isturf(loc))
...
/mob/living/danimal/hostile/asteroid/hivelordbrood/legion/proc/infest(mob/living/carbon/human/H)
	visible_message(span_warning("[name] burrows into the flesh of [H]!"))
	var/mob/living/danimal/hostile/asteroid/hivelord/legion/L
	if(HAS_TRAIT(H, TRAIT_DWARF)) //dwarf legions aren't just fluff!
		L = new /mob/living/danimal/hostile/asteroid/hivelord/legion/dwarf(H.loc)
	else
		L = new(H.loc)
...
/mob/living/danimal/hostile/asteroid/hivelord/legion/advanced
	stat_attack = DEAD
	maxHealth = 120
	health = 120
	brood_type = /mob/living/danimal/hostile/asteroid/hivelordbrood/legion/advanced
	icon_state = "dwarf_legion"
	icon_living = "dwarf_legion"
	icon_aggro = "dwarf_legion"
	icon_dead = "dwarf_legion"

/mob/living/danimal/hostile/asteroid/hivelordbrood/legion/advanced
	stat_attack = DEAD
	can_infest_dead = TRUE

//Legion that spawns Legions
/mob/living/danimal/hostile/big_legion
	name = "legion"
	desc = "One of many."
...
/mob/living/danimal/hostile/big_legion/Initialize()
	.=..()
	AddComponent(/datum/component/spawner, list(/mob/living/danimal/hostile/asteroid/hivelord/legion), 200, faction, "peels itself off from", 3)
...
// Snow Legion
/mob/living/danimal/hostile/asteroid/hivelord/legion/snow
	name = "snow legion"
	...
	crusher_loot = /obj/item/crusher_trophy/legion_skull
	loot = list(/obj/item/organ/regenerative_core/legion)
	brood_type = /mob/living/danimal/hostile/asteroid/hivelordbrood/legion/snow

/mob/living/danimal/hostile/asteroid/hivelord/legion/snow/tendril
	fromtendril = TRUE

// Snow Legion skull
/mob/living/danimal/hostile/asteroid/hivelordbrood/legion/snow
	name = "snow legion"
	desc = "One of many."
	icon = 'icons/mob/icemoon/icemoon_monsters.dmi'
