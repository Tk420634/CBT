/mob/living/danimal/hostile/eldritch
	name = "Demon"
	real_name = "Demon"
	desc = ""
	gender = NEUTER
...
/mob/living/danimal/hostile/eldritch/Initialize()
	. = ..()
	add_spells()
 ...
 */
/mob/living/danimal/hostile/eldritch/proc/add_spells()
	for(var/spell in spells_to_add)
		AddSpell(new spell())

/mob/living/danimal/hostile/eldritch/raw_prophet
	name = "Raw Prophet"
...
/mob/living/danimal/hostile/eldritch/raw_prophet/Initialize()
	. = ..()
	link_mob(src)

/mob/living/danimal/hostile/eldritch/raw_prophet/Login()
	. = ..()
	client.change_view(10)

/mob/living/danimal/hostile/eldritch/raw_prophet/proc/link_mob(mob/living/mob_linked)
...
/mob/living/danimal/hostile/eldritch/raw_prophet/proc/unlink_mob(mob/living/mob_linked)
	if(!linked_mobs[mob_linked])
		return
...
/mob/living/danimal/hostile/eldritch/raw_prophet/death(gibbed)
	for(var/linked_mob in linked_mobs)
		unlink_mob(linked_mob)
	return ..()

/mob/living/danimal/hostile/eldritch/armsy
	...
	var/mob/living/danimal/hostile/eldritch/armsy/front
	///Your old location
	var/oldloc
...
/mob/living/danimal/hostile/eldritch/armsy/Initialize(mapload,spawn_more = TRUE,len = 6)
	. = ..()
	if(len < 3)
	...
	allow_pulling = TRUE
	///next link
	var/mob/living/danimal/hostile/eldritch/armsy/next
	///previous link
	var/mob/living/danimal/hostile/eldritch/armsy/prev
	///current link
	var/mob/living/danimal/hostile/eldritch/armsy/current
...
/mob/living/danimal/hostile/eldritch/armsy/has_gravity(turf/T)
	return TRUE


/mob/living/danimal/hostile/eldritch/armsy/can_be_pulled()
	return FALSE

///Updates chain links to force move onto a single tile
/mob/living/danimal/hostile/eldritch/armsy/proc/contract_next_chain_into_single_tile()
	if(back)
		back.forceMove(loc)
...
/mob/living/danimal/hostile/eldritch/armsy/proc/update_chain_links()
	gib_trail()
...
/mob/living/danimal/hostile/eldritch/armsy/proc/gib_trail()
...
/mob/living/danimal/hostile/eldritch/armsy/Destroy()
	if(front)
...
/mob/living/danimal/hostile/eldritch/armsy/BiologicalLife(seconds, times_fired)
	adjustBruteLoss(-2)

/mob/living/danimal/hostile/eldritch/armsy/proc/heal()
	if(health == maxHealth)
		if(back)
			back.heal()
			return
			...
			if(current_stacks >= stacks_to_grow)
				var/mob/living/danimal/hostile/eldritch/armsy/prev = new type(drop_location(),spawn_more = FALSE)
...
/mob/living/danimal/hostile/eldritch/armsy/prime
...
/mob/living/danimal/hostile/eldritch/armsy/prime/Initialize(mapload,spawn_more = TRUE,len = 9)
	. = ..()
	var/matrix/matrix_transformation = matrix()
	matrix_transformation.Scale(1.4,1.4)
	transform = matrix_transformation

/mob/living/danimal/hostile/eldritch/armsy/primeproc/heal()
	if(health == maxHealth)
		if(back)
			back.heal()
			return
...
/mob/living/danimal/hostile/eldritch/rust_spirit
	name = "Rust Walker"
	real_name = "Rusty"
...
/mob/living/danimal/hostile/eldritch/rust_spirit/setDir(newdir, ismousemovement)
	. = ..()
	if(newdir == NORTH)
...
/mob/living/danimal/hostile/eldritch/rust_spirit/Moved()
	. = ..()
	playsound(src, 'sound/effects/footstep/rustystep1.ogg', 100, TRUE)

/mob/living/danimal/hostile/eldritch/rust_spirit/Life()
	if(stat == DEAD)
		return ..()
...
/mob/living/danimal/hostile/eldritch/ash_spirit
	name = "Ash Man"
	real_name = "Ashy"
	desc = "Incomprehensible abomination actively seeping life out of it's surrounding."
...
/mob/living/danimal/hostile/eldritch/stalker
	name = "Flesh Stalker"
