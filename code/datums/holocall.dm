...
//creates a holocall made by `the_one_who_called` from `calling_pad` to `callees`
/datum/holocall/New(mob/living/the_one_who_called, obj/machinery/holopad/calling_pad, list/callees, elevated_access = FALSE)
	call_start_time = world.time
	user = the_one_who_called
...
//RECORDS
/datum/holorecord
	var/caller_name = "Unknown" //the_one_who_called name
...
//These build the_one_who_called image from outfit and some additional data, for use by mappers for ruin holorecords
