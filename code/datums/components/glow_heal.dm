...
/datum/component/glow_heal/Initialize(mob/living/danimal/chosen_targets, allow_revival = TRUE, restrict_faction = null, list/type_healing = BRUTELOSS | FIRELOSS | TOXLOSS | OXYLOSS, color_glow = null)
	if(!isliving(parent))
