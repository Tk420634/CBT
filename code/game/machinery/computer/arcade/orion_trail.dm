				...
				if(prob(success))
					...
					if(prob(success*5))
						...
						if(obj_flags & EMAGGED)
							...
							for(var/i, i<=3, i++)
								var/mob/living/danimal/hostile/renegade/syndicate/ranged/smg/orion/O = new/mob/living/danimal/hostile/renegade/syndicate/ranged/smg/orion(get_turf(src))
								O.GiveTarget(usr)
...
/mob/living/danimal/hostile/renegade/syndicate/ranged/smg/orion
