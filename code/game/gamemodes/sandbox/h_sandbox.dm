...
/datum/hSB/proc/update()
	var/static/list/hrefs = list(
			...
			"Bots",
			"Spawn Cleanbot"					= "hsbspawn&path=[/mob/living/danimal/bot/cleanbot]",
			"Spawn Floorbot"					= "hsbspawn&path=[/mob/living/danimal/bot/floorbot]",
			"Spawn Medbot"						= "hsbspawn&path=[/mob/living/danimal/bot/medbot]",
