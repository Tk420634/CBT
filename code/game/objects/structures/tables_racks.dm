...
/obj/structure/table/CanAStarPass(obj/item/card/id/ID, to_dir, atom/movable/the_one_who_called)
	. = !density
	if(istype(the_one_who_called))
		. = . || (the_one_who_called.pass_flags & PASSTABLE)
...
/obj/structure/rack/CanAStarPass(ID, dir, the_one_who_called)
	. = !density
